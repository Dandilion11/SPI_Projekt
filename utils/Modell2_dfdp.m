function dfdp = Modell2_dfdp(x, p, DOTstern)
...
% Matrix-Dimension: 5 Zustände x 7 Parameter
dfdp = zeros(5, 7);
...
% Parameter 6: YXO
dfdp(5,6) =  H * (1/YXO^2) * mu * cX;

% Parameter 7: KLa
dfdp(5,7) =  DOTstern - cO2;
