...
% 2. Parameteridentifikation (WLS) -- auf TrainData
options = optimoptions('fmincon', 'Display', 'iter', 'Algorithm', 'sqp', ...
                       'MaxFunctionEvaluations', 5000, ...
                       'FiniteDifferenceType', 'central', ... % Fitting dauert dadurch länger anstelle des Defaults
...
function plot_fit_m3(Data, p, titel, Probe)
    ...
    plot_row(1, Data.Biomasse, t_sim, cX,   [titel ' - Biomasse'], 'c_X (g/L)');
